...
<TR>
      <TD align="center">
          <TABLE width="100%"  border="0" tyle="background-color: #DCDCDC;">
            <TR>
                <td class="ErrorMessage" align="left">You have been locked out of clinSiGHT due to too many incorrect login attempts.<br><br> Please contact your system administrator for further assistance.
                 </td>
             </tr>
          </table>
      </TD>
