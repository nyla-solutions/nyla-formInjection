...
<script>
   ...
   function showMultiSelect(aMultiSelectName, aInputID)
   {
     ...
     //alert('href='+multiSelectLink.href);
      ...
      //alert('scriptCode='+scriptCode);
        ...
        setTimeout("resizeMultiSelect(multSelectWindow)",50);
  ...
  function postFormDeviation(aForm)
  {
  	  try {
          ...
          var url = '<c:url value="/do/formAction?op=createForUnscheduled&siteID=${sessionScope.siteID}&relatedFormIDProp=${form.primaryKey}&formTypeName=Protocol Deviation"/>';
          
          window.location = url;
      }
      catch (err) {
      	// seems to happen when pressing 'cancel' when prompted to leave the page
      }
}//--------------------------------------------
</script>
</head>
  <body topmargin="0" leftmargin="10" rightmargin="10" onclick="hideCalendar()">
       ...
       <tr>
         <td width="100%">
           <div id="topnav">
           	  ...
           	  <c:choose>
           	  	<c:when test='${(!empty sessionScope.navigationContext) && sessionScope.navigationContext != "MyForms"}'>
	           	  <c:choose>
              ...
              <td width="100%">
                <div id="container" style="position: relative; width:100%; overflow: none; border: solid 0px #CCCCFF">
                  <table cellpadding="0" cellspacing="0" border="0" width="100%">
                  	<c:if test="${!(empty sessionScope.siteID) || sessionScope.navigationContext == 'MyForms'}">
                            ...
                            <td align="left" valign="top" width="100%">
                                   <tr>
                                        <td colspan="2" valign="top">
                                            <div align="left" id="overview" style="position: relative; overflow: none; width:100%; border: solid 0px #FFFFFF">
    ...
    <div style="position:absolute; display:none" id="cal">
		<iframe width="146" height="124" name="gToday:mini:agenda.js:gfFlat_mydate:mini_plugins.js" id="gToday:mini:agenda.js:gfFlat_mydate:mini_plugins.js" src="/gcsm/skins/default/js/calendar/iflateng.htm" scrolling="no" frameborder="0" marginwidth="0" marginheight="0"></iframe>
	</div>
  <div style="display:none"><img id="img_delRow" src="<html:rewrite page="/skins/default/images/form_delete_dynamic_row.gif"/>"/></div>
  </body>
</html>
<tiles:insert attribute="footerExtra" flush="false" ignore="true"/>