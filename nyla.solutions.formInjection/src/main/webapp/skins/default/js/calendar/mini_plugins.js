...
function fAfterSelected(y,m,d,e) {
	//alert("setting value for " + gContainer.dateFieldName);
	var prefix = gContainer.dateFieldName;
	var formRef=gContainer.form; // you may change this if you have more than 1 forms on page
	//alert("mini_plugins.js: " + formRef.name);
	formRef.elements[prefix].value=(d<10?'0'+d:d)+'-'+monthArray[m-1]+'-'+y;
	gContainer.hideCalendar();
	window.status = "";
}
