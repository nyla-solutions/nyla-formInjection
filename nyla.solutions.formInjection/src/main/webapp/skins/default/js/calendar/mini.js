...
var giCellWidth=1;	// calendar cell width; if set to -1, it'll be auto-adjusted so as to ensure the width of the entire calendar fits in with the calendar's direct parent tag. NN4 doesn't support -1.
var giCellHeight=3;	// calendar cell height;
var giHeadHeight=3;	// calendar head row height;
var giWeekWidth=1;	// calendar week-number-column width;
