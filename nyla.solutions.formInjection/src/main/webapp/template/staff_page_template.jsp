                        ...
                        <td align="left" valign="top">
                            ...
                            <tr>
                                ...
                                <div align="container" id="container" style="position: relative; width:100%; overflow: none;">
                                    ...
                                    <logic:equal value="LD" name="roleCd">
                                        <tr>
                                            <td colspan="3" valign="top" >
                                                <div align="center" id="admin" style="overflow: none; width:100%; border: solid 2px #FFFFFF">
                                                            <tiles:insert flush="false" attribute="admin" />
                                                </div>
                                            </td>
                                        </tr>
                                    </logic:equal> 
                                    <logic:notEqual value="LD"  name="roleCd">  
                                         <logic:equal value="SMM" name="roleCd">
                                            <tr>
                                                <td colspan="3" valign="top" >
                                                    <div align="center" id="staff" style="overflow: none; width:100%; border: solid 2px #FFFFFF">
                                          ...
                                          <logic:notEqual value="SMM" name="roleCd">
                                          <logic:equal value="PTM" name="roleCd">
                                            <tr>
                                                <td colspan="3" valign="top" >
                                                    <div align="center" id="sites">
                                                         <tiles:insert flush="false" attribute="sites"/>
                                                    </div>
                                                </td>
                                            </tr>
                                          </logic:equal>
                                          <logic:notEqual value="PTM" name="roleCd">
                                            <tr>
