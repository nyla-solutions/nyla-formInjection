 ...
 * @version 1.0
 */
public class OneLessThanEqualTwoExpression extends TwoQuestionOperandExpression
{  
   /**
    * 
   ...
   public boolean interpret(FormComponent aBusinessComponent)
   {
      ...
      return lessThan(formQuestion1, formQuestion2);      
   }//--------------------------------------------
   /**
    * 
    ...
    */
   public boolean lessThan(FormQuestion formQuestion1,FormQuestion formQuestion2)
   {
   ...
   static final long serialVersionUID = OneLessThanEqualTwoExpression.class
   .getName().hashCode();
}
