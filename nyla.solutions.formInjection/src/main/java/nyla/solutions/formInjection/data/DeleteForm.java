 ...
 * @version 1.0
 */
public class DeleteForm implements PrimaryKey, Createable, Serializable,
		Cloneable, Textable, Identifier
...
//	{
//		DeleteForm that = (DeleteForm) aFrom;
...
//	{
//		DeleteForm newForm = new Application();
//		newForm.copy(this);
//		return newForm;
//	}
...
//	}
	...
	// for retrofit
	// ---------------------------------------------
//	public DeleteForm retrieveForm()
//	{
//		return getForm();
//	}
...
//	}
	...
	static final long serialVersionUID = DeleteForm.class.getName().hashCode();
	/**
